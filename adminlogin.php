...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="admincheck.php" id="loginForm" method="post">
        <h4 class="title"><i class="material-icons">&#xE879;</i>Admin Login</h4>
        <div class="form-body">
          <div class="input-grp">
            <label for="email">Username</label>
            <input type="text" class="input-txt" name="email" placeholder="johndoe@example.com">
          </div>
          <div class="input-grp">
