    ...
    <div class="col-lg-4">
      <form action="" method="post">
        <div class="form-group"><br>
          Enter New Admin Mail<br>
          <input type="text" name="newemail" required="" class="form-control"><br>
          Enter password <br>
          <input type="password" name="adminpass" required="" class="form-control"><br>
...
require("../php/connect.php");
  if((isset($_POST["newemail"])) && (isset($_POST["adminpass"])))
  {
    $sql1="SELECT Password FROM des WHERE Email='$_SESSION[user]'";
    $res1=mysqli_query($db,$sql1);
    print_r(mysqli_error($db));
    $row1=mysqli_fetch_assoc($res1);
    if($row1["Password"]==$_POST["adminpass"])
    {
      $sql2="UPDATE des SET Email='$_POST[newemail]' WHERE Role='admin'";
